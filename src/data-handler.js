...
function initializeLocalStorage() {
  if (localStorage.getItem("boards")) {
    ...
    localStorage.setItem(
      "boards",
      JSON.stringify([
        // Pre-made content for demonstration purposes
        {
          ...
          tasks: [
            {
              ...
              description:
                "In this task, you will enhance the user experience by implementing form validation for various input fields. Form validation ensures that user-submitted data is accurate, complete, and meets specified criteria.",
            ...
            },
            {
              ...
              description:
                "Ensure that the Kanban project is accessible and responsive on various devices, including desktops, tablets, and smartphones. Implement responsive design practices to provide an optimal user experience across different screen sizes.",
            ...
            },
            {
              ...
              description:
                "Develop Create, Read, Update, Delete functions for tasks and boards. This task is fundamental for enabling users to manage and organize their tasks and boards efficiently, enhancing the project's usability and functionality.",
            ...
            },
            {
              ...
              description:
                "Create a user interface that dynamically updates and displays tasks, boards, and details as users interact with the system. Ensure a seamless and responsive user experience that reflects real-time changes.",
              dueDate: format(add(new Date(), { days: 11 }), "yyyy-MM-dd"),
              priority: "high",
              status: "done",
            },
            {
              ...
              description:
                "Add a light and dark mode toggle feature to enhance the user experience. Users can switch between different visual modes based on their preferences and reduce eye strain during extended usage.",
          ...
          tasks: [
            {
              ...
              description:
                "Create a visual prototype of the restaurant project using Figma. This prototype will serve as a design reference and help in visualizing the project's user interface and user experience.",
              dueDate: format(add(new Date(), { days: 3 }), "yyyy-MM-dd"),
              priority: "medium",
              status: "todo",
            },
            {
              ...
              description:
                "Set up distinct environments for development and production. This includes configuring npm packages and webpack loaders to ensure a smooth transition from development to production for the restaurant project.",
            ...
            },
            {
              ...
              description:
                "In this task, you will gather all the necessary assets required for the Project. Assets are essential components that contribute to the project's visual and functional elements.",
        ...
        },
        {
          ...
          tasks: [
            {
              title: "Buy a C'est Vous Le Chant for the Party",
              description:
                "Check out which are the best lechons in Manila and order one for the party. Ensure that this porcine masterpiece is seasoned to hog-heaven perfection.",
            ...
            },
            {
              ...
              description:
                "Design and send out invitations well in advance. Inform the guests of the venue, date, and time. Ensure that all invited guests receive their invitations in a timely and organized manner.",
              dueDate: "2023-09-24",
              priority: "medium",
              status: "done",
            },
            {
              title: "Plan the Menu",
              description:
                "Decide what's on the menu. Consider your grandmother's favorite dishes and any dietary restrictions she might have. Keep it simple and delicious.",
              dueDate: "2023-09-25",
              priority: "low",
              status: "done",
            },
            {
              ...
              description:
                "Use my persuasion skills, and maybe a tickle or two to coax the grandchildren onto the dance floor, even if they initially resist. The goal is to turn reluctant shufflers into spontaneous dancers.",
              dueDate: format(add(new Date(), { days: 1 }), "yyyy-MM-dd"),
              priority: "low",
              status: "todo",
            },
            {
              ...
              description:
                "The ultimate task at hand is to fill Mamay's heart with happiness on her 86th birthday. It's about creating an atmosphere of love and joy, where she feels cherished and surrounded by the warmth of family and friends.",
              dueDate: format(add(new Date(), { days: 1 }), "yyyy-MM-dd"),
              priority: "high",
              status: "doing",
            },
...
function addNewBoard() {
  ...
  if (localStorage.getItem("boards")) {
    // checks if boards is empty. if empty, initialize an array
...
function editBoard() {
  ...
  const indexOfActiveBoard = boards.findIndex(
    (board) =>
      JSON.stringify(board.title) === JSON.stringify(getActiveBoard().title)
  );
